...
<div style="display: flex; justify-content: space-around; "><br>    
    ...
    <img src="https://static-00.iconduck.com/assets.00/nestjs-plain-icon-512x510-3pkb2qwx.png" loading="lazy" class="icon loaded" onload=";" onerror="LoadUtils.handleImageLoadError(this);" alt="nestjs plain icon" title="nestjs plain icon" data-alternate="https://d1rs1tqcxzgl1z.cloudfront.net/iconduck/image/upload/w_614,h_614,c_fit/f_png/e_colorize:0,co_rgb:000000/w_644,h_644,c_lpad/e_trim:1/w_512,h_512,c_fit/s3.prod/assets.00/asst8r3b9h1n">
